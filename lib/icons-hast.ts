 ...
 */
export const VALID_NOTE_TYPES = ['note', 'tip', 'important', 'quote', 'bonus'] as const
 ...
 */
export const importantIcon: Element = {
  type: 'element',
  tagName: 'svg',
  properties: {
    viewBox: '0 0 18 18',
 ...
 */
export const quoteIcon: Element = {
  type: 'element',
  tagName: 'svg',
  properties: {
    viewBox: '0 0 24 24',
 ...
 */
export const bonusIcon: Element = {
  type: 'element',
  tagName: 'svg',
  properties: {
    viewBox: '0 0 24 24',
 ...
 */
export const ICON_HAST_MAP: Record<ValidNoteType, Element> = {
  note: noteIcon,
  tip: tipIcon,
